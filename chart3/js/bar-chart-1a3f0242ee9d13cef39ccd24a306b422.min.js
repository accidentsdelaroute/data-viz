 ...
 * generated on 2016-03-14T14:08:57+01:00
 */
/*! datawrapper - v1.10.2 */
...
if(lpos){lbl.animate({align:lpos.halign,x:lpos.left,y:lpos.top},me.theme().duration,me.theme().easing);}});});if(me.__domain[0]<0){var c=me.__canvas,x=c.lpad+c.zero,p='M'+[x,c.tpad]+'V'+c.lastBarY;if(me.__yaxis){me.__yaxis.forEach(function(axis){axis.animate({path:p,opacity:1},me.theme().duration,me.theme().easing);});}else{me.__yaxis=[me.path(p,'axis').attr(me.theme().yAxis)];}}else if(me.__yaxis){me.__yaxis.forEach(function(axis){axis.animate({opacity:0},me.theme().duration*0.5,me.theme().easing);});}
